...
Slice 9 is implemented; see [personal-theme notes](../implementation/slice-09-personal-themes.md). Export and the remaining release gates are next in Slice 10. Preserve real production data, stable workflow identities, immutable history, Space-local dates, bounded pages, and recipient privacy.
